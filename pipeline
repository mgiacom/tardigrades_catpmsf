...
pb_mpi  -s  matrix_40sp.fasta. -T  sister_to_lobopodia.tree  -cat -poisson  sister_to_lobopodia_chain1/2
...
iqtree2 -s  matrix_40sp.fasta -m Poisson+G4 --wbtl  -wsr  -fs  sister_to_lobopodia.sitefreq  -bb 1000  -T 12  
